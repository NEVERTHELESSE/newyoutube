...
} from "./chunk-S4NZIX2T.js";
import {
  ListSymbol,
  RAFLoop,
  TimeRange
} from "./chunk-V52I7CR7.js";
import {
  DOMEvent,
  createScope,
  effect,
...
// node_modules/@vidstack/react/dev/chunks/vidstack-BM8_lxar.js
...
var GoogleCastTracksManager = class {
  ...
  syncRemoteTracks(event) {
    ...
    const localAudioTracks = __privateMethod(this, _GoogleCastTracksManager_instances, getLocalAudioTracks_fn).call(this), localTextTracks = this.getLocalTextTracks(), remoteAudioTracks = __privateMethod(this, _GoogleCastTracksManager_instances, getRemoteTracks_fn).call(this, REMOTE_TRACK_AUDIO_TYPE), remoteTextTracks = __privateMethod(this, _GoogleCastTracksManager_instances, getRemoteTracks_fn).call(this, REMOTE_TRACK_TEXT_TYPE);
...
getRemoteActiveIds_fn = function() {
  ...
  if (activeLocalAudioTrack) {
    const remoteAudioTracks = __privateMethod(this, _GoogleCastTracksManager_instances, getRemoteTracks_fn).call(this, REMOTE_TRACK_AUDIO_TYPE), remoteAudioTrack = __privateMethod(this, _GoogleCastTracksManager_instances, findRemoteTrack_fn).call(this, remoteAudioTracks, activeLocalAudioTrack);
  ...
  if (activeLocalTextTracks == null ? void 0 : activeLocalTextTracks.length) {
    const remoteTextTracks = __privateMethod(this, _GoogleCastTracksManager_instances, getRemoteTracks_fn).call(this, REMOTE_TRACK_TEXT_TYPE);
...
//# sourceMappingURL=vidstack-BM8_lxar-AYA5UERF.js.map
