...
var AudioProviderLoader = class {
  ...
  async load() {
    ...
    return new (await import("./provider-LS7XW5T2.js")).AudioProvider(this._audio);
  }
  render($store) {
    return (() => {
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    ...
    return new (await import("./provider-OIRQKQTM.js")).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./provider-2E67C3GX.js")).HLSProvider(this._video, context);
  }
};
...
var MediaLoadController = class extends ComponentController {
  ...
  async onAttach(el) {
    ...
    if (load === "eager") {
      ...
      const { waitIdlePeriod } = await import("./std-PPA327XM.js");
...
var TextTrack = class extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      import("./dev-R7QAODMV.js").then(({ parseText, VTTCue, VTTRegion }) => {
        if (init.type === "json") {
  ...
  /* @internal */
  [(_d = TEXT_TRACK_READY_STATE, _c = TEXT_TRACK_CROSSORIGIN, _b = TEXT_TRACK_ON_MODE_CHANGE, _a4 = TEXT_TRACK_NATIVE, TEXT_TRACK_UPDATE_ACTIVE_CUES)](currentTime, trigger) {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-R7QAODMV.js"), crossorigin = (_a6 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a6.call(this);
...
var ThumbnailsLoader = class extends ComponentController {
  ...
  _onLoadCues() {
    ...
    if (!src)
      return;
    import("./dev-R7QAODMV.js").then(({ parseResponse }) => {
      parseResponse(
        fetch(src, {
...
var LibASSTextRenderer = class {
  constructor(loader, config) {
    ...
    __publicField(this, "_track", null);
    __publicField(this, "_typeRE", /(ssa|ass)$/);
    this.loader = loader;
    this.config = config;
  }
  canRender(track) {
  ...
  attach(video) {
    this.loader().then(async (mod) => {
      ...
      listenEvent(this._instance, "ready", () => {
        var _a7;
        const canvas = (_a7 = this._instance) == null ? void 0 : _a7._canvas;
        if (canvas)
...
maverick.js/dist/dev/chunks/chunk-FIEGXSET.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Y6S2BEXD.js.map
