...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./srt-parser-FPSBGAGU.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./ssa-parser-JALCE6CO.js")).default;
        break;
      default:
...
var VTTParser = class {
  ...
  async init(init) {
    ...
    if (init.strict)
      this._block = 1;
    if (init.errors)
      this._errorBuilder = (await import("./errors-SS6DQIFU.js")).ParseErrorBuilder;
  }
...
//# sourceMappingURL=chunk-M2RQ7CWB.js.map
